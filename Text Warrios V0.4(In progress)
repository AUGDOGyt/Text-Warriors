    ...
    while combatLoop=="True":
      if enemyInitiative >= playerInitiative:
        ...
        if decision !=" ":
          ...
          damageDealt=weaponAttack-(0.3*enemyArmor)
          mgcDamageDealth=weaponMagic/enemyMgcRes
          if damageDealt<1:
            damageDealt=0
          print("you deal ",damageDealt," normal damage and ",mgcDamageDealt," magic damage")
        ...
        if playerStats.playerHealth==0:
          ...
          if enemyHealth==0:
            print("You won!")
            playerStats.gold=playerStats.gold+(random.randrange(20,100))
            combatLoop="False"
    return
  def comatLoopspiderSwarm():
    ...
    while combatLoop=="True":
      if enemyInitiative >= playerInitiative:
        ...
        print("You ready to attack the spider swarm")
        damageDealt=weaponAttack-enemyArmor
        mgcDamageDealt=weaponMagic/enemyMgcRes
        if damageDealt<1:
          damageDealt=0
  ...
  def comatLoopspider():
    ...
    while combatLoop=="True":
      if enemyInitiative >= playerInitiative:
        ...
        print("You ready to attack the spider swarm")
        phyDamageDealt=weaponAttack-enemyArmor
        mgcDamageDealt=weaponMagic/enemyMgcRes
        damageDealth=phyDamageDealt+mgcDamageDealt
        if damageDealt<1:
          damageDealt=0
        print("you deal ",damageDealt," damage.")
        decision=" "
        decision=str(input("proceed?"))
        print("")
        if decision !=" ":
